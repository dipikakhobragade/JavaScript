...
const arrayStudents = [jenny,bill,elon,ratan];
...
console.log(`===WAP to find the student from city Pune or Hyd=====`);
...
console.log(`====WAP to find the avg marks`);
...
console.log(`Total marks of all student ${totalMarks}`);
 const avgMarks = totalMarks/arrayStudents.length;
